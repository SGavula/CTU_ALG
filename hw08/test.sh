...
# Test11 Mandatory
./hw01 < datapub/pub11.in > datapub/my-pub11.out;
diff datapub/pub11.out datapub/my-pub11.out;

# Test12 Mandatory
./hw01 < datapub/pub12.in > datapub/my-pub12.out;
diff datapub/pub12.out datapub/my-pub12.out;

# Test13 Mandatory
./hw01 < datapub/pub13.in > datapub/my-pub13.out;
diff datapub/pub13.out datapub/my-pub13.out;

# Test14 Mandatory
./hw01 < datapub/pub14.in > datapub/my-pub14.out;
diff datapub/pub14.out datapub/my-pub14.out;